        ...
        <div class="col-md-12 g-0">
            ...
            <div class="list-group list-group-flush mt-3" id="accordion">
                <div class="card list-group-item-primary">
                    <div class="card-header clearfix">
                        <h4 class="mb-0 float-start">
                            <a class="collapsed text-decoration-none" data-bs-toggle="collapse" data-parent="#accordion" href="#userDetail" role="button" aria-expanded="false" aria-controls="userDetail">
                ...
                <div class="card list-group-item-primary">
                    <div class="card-header clearfix">
                        <h4 class="mb-0 float-start">
                            <a data-bs-toggle="collapse" data-parent="#accordion" href="#collapse2" class="collapsed text-decoration-none" aria-expanded="false">
                                Quyền hạn được cấp
                            </a>
                        </h4>
                        <div class="btn-group float-end">
