...
namespace Modules\TripBooking\src\Providers;
...
class TripBookingServiceProvider extends ServiceProvider
{
    /**
     ...
     * @var string
     */
    private $MODULE_NAME = 'TripBooking';
    private $module_path = __DIR__ . '/../../';
    protected $seeds_path = 'Modules\TripBooking\Database\Seeders';
    ...
    public function load_config($path, $module) {
        ...
        if (File::exists( $path . 'config' )) {
            //to published this config: php artisan vendor:publish --provider="Modules\TripBooking\src\Providers\TripBookingServiceProvider" --tag=config --force
