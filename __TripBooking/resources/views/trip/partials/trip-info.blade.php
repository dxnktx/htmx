<div class='row mb-3 mt-3'>
    ...
    <div class='col-sm-10'>
        <textarea name='hoan_canh_gia_dinh' cols="30" rows="5" class='form-control @error('hoan_canh_gia_dinh') is-invalid @enderror' placeholder="Mô tả chi tiết hoàn cảnh gia đình (hộ nghèo, cận nghèo, khó khăn, bão lũ), nếu thuộc diện chính sách vui lòng ghi rõ" required>{{ old('hoan_canh_gia_dinh', $trip->hoan_canh_gia_dinh) }}</textarea>
...
<div class='row mb-3'>
    ...
    <div class='col-sm-10'>
        <textarea name='hoan_canh_ban_than' cols="30" rows="5" class='form-control @error('hoan_canh_ban_than') is-invalid @enderror' placeholder="Mô tả hoàn cảnh bản thân hiện tại" required>{{ old('hoan_canh_ban_than', $trip->hoan_canh_ban_than) }}</textarea>
